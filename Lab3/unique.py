from genRandom import genRandom1
...
if __name__ == '__main__':
    ...
    data_rand = genRandom1(10, 3, 10)  # генерируется 10 случайных чисел от 3 до 10
    data_str = ['a', 'A', 'b', 'B', 'a', 'A', 'b', 'B']
    print('Отбор уникальных чисел: ', str(list(Unique1(data_int)))[1:-1])
    print('Отбор уникальных случайных чисел: ', str(list(Unique1(data_rand)))[1:-1])
    print('Отбор уникальных строк без игнорирования регистра по умолчанию: ', str(list(Unique1(data_str)))[1:-1])
    print('Отбор уникальных строк с игнорированием регистра: ', str(list(Unique1(data_str, ignore_case=True)))[1:-1])
    print('Отбор уникальных строк без игнорирования регистра: ', str(list(Unique1(data_str, ignore_case=False)))[1:-1])
